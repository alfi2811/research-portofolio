...
import { check_login, post_view_user } from '../../redux/actions/main'
        ...
        <div className="profile-container">
          <div className="info">                    
            <div className="left">
                ...
                {
                  id === window.localStorage.id_user &&
                  <Link to="/edit-user">
            ...
            <div className="right">
              <div className="detail">
                <h2>{ data?.fullname }</h2>
                <h3>{ data?.role && data?.role + ' at'} { data?.affiliation }</h3>
